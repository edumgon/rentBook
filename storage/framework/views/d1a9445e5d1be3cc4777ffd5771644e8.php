        ...
        <div class="px-4 py-6 sm:px-0">
            <div class="bg-white shadow-lg rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div class="bg-blue-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-2 text-sm">
                            <p><strong>Tenant ID:</strong> <code class="bg-blue-100 px-2 py-1 rounded"><?php echo e($tenantId); ?></code></p>
                            <p><strong>User ID:</strong> <?php echo e($userId); ?></p>
                            <p><strong>User Email:</strong> <?php echo e(auth()->user()->email); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="bg-green-50 p-4 rounded-lg">
                        ...
                        <div class="space-y-2 text-sm">
                            <p><strong>Books:</strong> <?php echo e($books); ?></p>
                            <p><strong>Borrowers:</strong> <?php echo e($borrowers); ?></p>
                            <p><strong>Loans:</strong> <?php echo e($loans); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t pt-6">
                    ...
                    <div class="space-y-3">
                        <form method="POST" action="<?php echo e(route('tenant.test.create')); ?>" class="inline">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH /var/www/resources/views/tenant-test.blade.php ENDPATH**/ ?>