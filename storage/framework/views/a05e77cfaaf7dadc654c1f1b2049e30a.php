    ...
    <main class="max-w-2xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0">
            ...
            <div class="bg-white shadow-lg rounded-lg p-6">
                <form method="POST" action="<?php echo e(route('borrowers.store')); ?>">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="mt-8 flex justify-end space-x-3">
                        <a href="<?php echo e(route('borrowers.index')); ?>" 
...
<?php /**PATH /var/www/resources/views/borrowers/create.blade.php ENDPATH**/ ?>