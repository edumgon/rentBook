        ...
        <div class="px-4 py-6 sm:px-0">
            ...
            <div class="mb-6">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex space-x-3">
                        <a href="<?php echo e(route('books.create')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                            ➕ Add Book
                        </a>
                    </div>
                </div>
                ...
                <form method="GET" action="<?php echo e(route('books.index')); ?>" class="space-y-4">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="search" value="<?php echo e($search); ?>" placeholder="Search by title, author, or ISBN..." 
                        ...
                        <div>
                            ...
                            <select name="status" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                                ...
                                <?php $__currentLoopData = $statuses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($status); ?>" <?php echo e($status == $status ? 'selected' : ''); ?>>
                    ...
                    <div class="flex justify-between items-center">
                        <p class="text-sm text-gray-600">
                            <?php echo e($books->total()); ?> book<?php echo e($books->total() != 1 ? 's' : ''); ?> found
                        </p>
                        <a href="<?php echo e(route('books.index')); ?>" class="text-sm text-blue-600 hover:text-blue-800">
                            Clear filters
                        </a>
                    </div>
                </form>
                        ...
                        <div class="bg-white shadow-lg rounded-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                            ...
                            <div class="h-48 bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center">
                                <div class="text-white text-center p-4">
                                    ...
                                    <div class="text-sm font-medium"><?php echo e(\Illuminate\Support\Str::limit($book->title, 30)); ?></div>
                                </div>
                            </div>
                            
                            <!-- Book Info -->
                            <div class="p-4">
                                <h3 class="font-semibold text-gray-900 mb-1"><?php echo e($book->title); ?></h3>
                                <p class="text-sm text-gray-600 mb-2">by <?php echo e($book->author); ?></p>
                                
                                <?php if($book->publisher): ?>
                                    <p class="text-xs text-gray-500 mb-2"><?php echo e($book->publisher); ?></p>
                                <?php endif; ?>
                                
                                <div class="flex justify-between items-center mb-3">
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                        <?php echo e($book->status == 'available' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
                                        <?php echo e(ucfirst($book->status)); ?>

                                    </span>
                                    
                                    <?php if($book->purchase_price): ?>
                                        <span class="text-sm text-gray-600">$<?php echo e(number_format($book->purchase_price, 2)); ?></span>
                                    <?php endif; ?>
                                </div>
            ...
            <?php else: ?>
                ...
                <div class="bg-white shadow-lg rounded-lg p-12 text-center">
                    ...
                    <a href="<?php echo e(route('books.create')); ?>" class="bg-blue-600 text-white px-6 py-3 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500">
                        Add Your First Book
                    </a>
                </div>
            <?php endif; ?>
...
<?php /**PATH /var/www/resources/views/books/index.blade.php ENDPATH**/ ?>